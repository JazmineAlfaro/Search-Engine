...
keywords_file =os.path.dirname(os.path.realpath(__file__))+'/search_keywords.txt'
...
for x in range(0, 3):
    ...
    if sort_weights:
        ...
        print_weight = ("Peso = %f"%(sort_weights[x][1]))
        print_weight = bcolors.BOLD + print_weight + bcolors.ENDC
        print("Resultado %d --> %s"%(x+1,print_weight))
        #print title
    ...
    for some_line in save_line_num:
        if some_line[1]==sort_weights[x][0]:
            ...
            print("Ultimas entradas para los terminos : %s"%(print_term))
            print("---------------------------------------------------------------------------------------------------------")
            print("---------------------------------------------------------------------------------------------------------")
...
for key in keys:
    ...
    if key in reducer_index:
        ...
        for idx in range(0, 3):
            ...
            # otherwise, we can retrieve data!
                ...
                print('Resultado  %d para la busqueda de la palabra ---> `%s`:\nTITULO: %s\t >> Repeticiones de la palabra: %s << \n%s' %
    ...
    # if we don't have the word, display this result for user
        ...
        print('------------------------------------')
        print('No se encontraron resultados para la palabra: "%s"' % key)
        print('------------------------------------')
